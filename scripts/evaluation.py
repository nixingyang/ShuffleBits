...
flags.DEFINE_string("source_feature_file_path", "msmt_bot_R50_Market1501.npz",
                    "File path of the source feature.")
flags.DEFINE_string("target_feature_folder_path", "Re-Identification_*",
...
def main(_):
    ...
    target_feature_file_paths = sorted(
        glob.glob(os.path.join(target_feature_folder_path, "**/*.npz"),
                  recursive=True))
    for target_feature_file_path in target_feature_file_paths:
        ...
        try:
            ...
            for source_feature_vector, target_feature_vector in zip(
                ...
                distance = pairwise_distances([source_feature_vector],
